    ...
    <div className="grid max-w-4xl gap-8">
      ...
      <section>
        ...
        <div className="panel grid gap-4 rounded-[22px] p-6 sm:grid-cols-2">
          <div className="rounded-2xl border p-5"><ShieldCheck className="size-5" /><h3 className="mt-4 text-sm font-semibold">Privacy policy</h3><p className="muted mt-1 text-xs leading-relaxed">Understand what Nexarch processes, why it is needed, and your data-protection rights.</p><Link href="/privacy" className="mt-4 inline-block text-sm font-medium underline underline-offset-4">Read privacy policy</Link></div>
