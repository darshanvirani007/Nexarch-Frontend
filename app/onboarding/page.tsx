  ...
  return <main className="mx-auto flex min-h-screen max-w-6xl flex-col p-5 sm:p-8">
    ...
    <div className="mx-auto my-auto w-full max-w-2xl py-14">
      ...
      <div className="mt-9 min-h-64">
        {step === 0 && <div className="grid gap-4 sm:grid-cols-2"><Field label="First name"><input className={inputClass} defaultValue="Darshan" /></Field><Field label="Last name"><input className={inputClass} placeholder="Your surname" /></Field><Field label="Timezone"><SelectControl options={["Europe/Dublin", "Europe/London", "America/New_York"]} defaultValue="Europe/Dublin" /></Field></div>}
